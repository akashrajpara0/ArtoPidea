...
public class ImageRemixProgressActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_image_remix_progress);
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent intent = new Intent(ImageRemixProgressActivity.this,
                        ImageRemixDownloadActivity.class);
