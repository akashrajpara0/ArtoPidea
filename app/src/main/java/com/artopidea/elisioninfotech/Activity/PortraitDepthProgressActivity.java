...
public class PortraitDepthProgressActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_portrait_depth_progress);
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent intent = new Intent(PortraitDepthProgressActivity.this,
                        PortraitDepthDownloadActivity.class);
