...
public class PortraitDepthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_portrait_depth);
        ...
        get_result_text.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent newIntent = new Intent(PortraitDepthActivity.this,
                        PortraitDepthProgressActivity.class);
