...
public class HighResolutionProgressActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_high_resolution_progress);
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent intent = new Intent(HighResolutionProgressActivity.this,
                        HighResolutionDownloadActivity.class);
