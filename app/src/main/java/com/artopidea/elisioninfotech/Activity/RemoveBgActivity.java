...
public class RemoveBgActivity extends AppCompatActivity {
    ...
    ImageView remove_background_banner;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        get_result_text.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent newIntent = new Intent(RemoveBgActivity.this,
                        RemoveBgProgressActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 1 && resultCode == RESULT_OK && data != null) {
            ...
            try {
                ...
                remove_background_banner.setVisibility(View.GONE);
    ...
    private void idBinding() {
        ...
        remove_background_banner = (ImageView) findViewById(R.id.remove_background_banner);
