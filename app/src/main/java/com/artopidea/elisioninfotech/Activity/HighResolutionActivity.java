...
public class HighResolutionActivity extends AppCompatActivity {

    ImageView upload_image;
    TextView get_result_text;
    ImageView uploaded_image;
    ImageView high_resolution_banner;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_high_resolution);
        ...
        get_result_text.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent newIntent = new Intent(HighResolutionActivity.this,
                        HighResolutionProgressActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 1 && resultCode == RESULT_OK && data != null) {
            ...
            try {
                ...
                high_resolution_banner.setVisibility(View.GONE);
    ...
    private void idBinding() {
        ...
        high_resolution_banner = (ImageView) findViewById(R.id.high_resolution_banner);
