...
public class PortraitSurfaceProgressActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_portrait_surface_progress);
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent intent = new Intent(PortraitSurfaceProgressActivity.this,
                        PortraitSurfaceDownloadActivity.class);
