...
final class MeowBottomNavigationCell extends RelativeLayout {
    ...
    public MeowBottomNavigationCell( Context context) {
        super(context);
        this.count = "empty";
        this.iconSize = Utils.dip(this.getContext(), 55);
        this.initializeView();
    }
    ...
    private void setProgress(float value) {
        ...
        var6.setX((1.0F - this.progress) * (float) (this.isFromLeft ? -m : m) + (float) (this.getMeasuredWidth() - Utils.dip(this.getContext(), 55)) / 2.0F);
